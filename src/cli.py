...
from src.agent import HusbandoAgent
...
class HusbandoCLI:
    def __init__(self):
        ...
        self.config_dir = Path.home() / '.Husbando'
    ...
    def _initialize_commands(self) -> None:
        ...
        self._register_command(
            Command(
                name="exit",
                description="Exits the Husbando CLI.",
    ...
    def _get_prompt_message(self) -> HTML:
        ...
        return HTML(f'<prompt>Husbando-CLI</prompt> {agent_status} > ')
    ...
    def _print_welcome_message(self) -> None:
        ...
        print_h_bar()
        logger.info("👋 Welcome to the Husbando CLI!")
    ...
    def _load_agent_from_file(self, agent_name):
        try: 
            self.agent = HusbandoAgent(agent_name)
